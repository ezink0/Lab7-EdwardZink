...
/**
 * Class to run the Rock, Paper, Scissors, Lizard, Spock Game
 * @author Edward Zink
 */
...
public class RPSLSpock {
    ...
    /**
     * Checks if the user's inputted pick is valid or not
     * @param pick - The player's choice
     * @return Whether or not the pick is valid or not
     */
    ...
    /**
     * Creates a random pick for the computer to use
     * @return The computer's randomly generated pick for the game
     */
    ...
    /**
     * Checks whether or not the computer wins based on the computer pick and player pick
     * @param c_pick The computer's pick
     * @param h_pick The player's pick
     * @return Whether the computer wins or not
     */
